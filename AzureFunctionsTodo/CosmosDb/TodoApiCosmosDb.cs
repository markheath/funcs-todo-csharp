...
namespace AzureFunctionsTodo.CosmosDb
{
    ...
    public static class TodoApiCosmosDb
    {
        ...
        public static IActionResult GetTodoById(
            ...
            [CosmosDB(DatabaseName, CollectionName, ConnectionStringSetting = "CosmosDBConnection", PartitionKey = "{id}",
                Id = "{id}")] Todo todo,
        ...
        public static async Task<IActionResult> DeleteTodo(
            ...
            ILogger log, string id)
        {
            var docLink = UriFactory.CreateDocumentUri(DatabaseName, CollectionName, id);
            await client.DeleteDocumentAsync(docLink, new RequestOptions() { PartitionKey = new PartitionKey(id) });
            return new OkResult();
        }
    }
}
